...
/// <summary>
/// Class for handling JsonHandler writing, reading, storing and overwriting
/// </summary>
sealed class JsonHandler {
    ...
    /// <param name="content"> Class as content to be written to the JsonHandler file. </param>
    ...
    /// <summary>
    /// Gets a value out of a class JsonHandler rather than reading the whole class JsonHandler
    /// </summary>
    /// <param name="path_string"> Path to read JsonHandler data from. Path is automatically appended to the current working directory </param>
